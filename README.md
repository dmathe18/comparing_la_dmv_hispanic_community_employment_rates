...
## Data Interpretation
The data appears to suggest that LA county offers better employment prospects for individuals of hispanic descent. The analysis should be qualified by the fact that a variety of confounding variables may be impacting the findings, and employment rates alone do not categorically define the quality of employment or say anything about income, quality of life, happiness, etc. These confounding variables may include asymmetric reporting practices, variable definitions of "Hispanic" among reporting firms, issues associated with subjective interpretation in relation to defining/tabulating discouraged workers, etc. I think in-depth statistical and graphical analyses of important social and economic outcomes are and will become increasingly important, and provide a useful metric of comparison by which to analyze progress, performance, and effectiveness of a variety of political policies and governmental initialtives.

This analysis could be expanded in future research in a number of ways. Hourly wages, salaries, bonuses, and other sources of income could be considered to provide a more holistic view of employment prospects. Moreover, the impact of taxes on net earnings should be assessed and factored into the analysis. Analyzing professional advancement and social mobility metrics may also help contextualize the above employment statistics, shedding light on opportunities for career growth and social advancement beyond just the average employment rate.
